...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 110523170L;
    ...
    public final com.example.demo.domain.QMission mission;

    public final EnumPath<com.example.demo.domain.enums.MissionStatus> status = createEnum("status", com.example.demo.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mission = inits.isInitialized("mission") ? new com.example.demo.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
